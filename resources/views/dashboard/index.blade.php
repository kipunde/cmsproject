  ...
  <div class="panel">
    <div class="panel-body">
      <div class="row mar-top">
        <div class="col-md-3">
          <div class="pad-all text-center">
              <span class="pad-ver text-main text-sm text-uppercase text-bold">Total Due Revenue Collections Commission</span>
              <p class="text-sm">{{date('dS F Y', strtotime( NOW() ) )}}</p>
              <p class="text-2x text-main">TSH 500000 </p>
        ...
        <div class="col-md-{{($user->isAdmin()) ? 5 : 9}}">
          <h3 class="text-center">Due Revenue Collections</h3>
          <div class="table-responsive">
        ...
        @if($user->isAdmin())
        <div class="col-md-4">
          <h3 class="text-center">Admin Owning</h3>
          <div class="table-responsive">
