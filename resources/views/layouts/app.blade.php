...
<body>
	<div id="container" class="effect aside-float aside-bright mainnav-lg">
                  	...
                  	{{Route::currentRouteName() === 'member.profile' ? 'active-sub' : ''}}">
										...
										<ul class="collapse">
											...
											<li class="{{ Route::currentRouteName() === 'member.register.form' ? 'active-sub active' : '' }}">
												<a href="{{route('member.register.form')}}"><i class="fa fa-registered"></i> Add New Member</a>
                      </li>
										</ul>
									</li>
									<!--Menu list item-->
	                      ...
	                      <a href="{{route('attendance.view.form')}}"><i class="fa fa-eye"></i> View Attendance</a>
									...
									<li class="{{ (Route::currentRouteName() === 'collection.offering' || Route::currentRouteName() === 'collection.report' || Route::currentRouteName() === 'collection.analysis') ? 'active-sub active' : ''}}">
										<a href="#">
											...
											<span class="menu-title">Revenue Collection</span>
											<i class="arrow"></i>
										</a>
										<ul class="collapse">
		...
		<footer id="footer">
			...
			Design By <a href="#" style="color:#274868;font-weight:bolder"> Luja Deying </a>
			</div>
			<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
			<!-- Remove the class "show-fixed" and "hide-fixed" to make the content always appears. -->
			<!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
			<p class="pad-lft">&#0169; {{date('Y')}} cmsproject</p>
		</footer>
		<!--===================================================-->
		<!-- END FOOTER -->
		<!-- SCROLL PAGE BUTTON -->
